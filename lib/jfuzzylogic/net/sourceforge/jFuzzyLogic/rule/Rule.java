...
public class Rule extends FclObject implements CompileCpp {
	...
	/** Grau de ativação da regra na geração de regras através do algoritmo de wang-mendel */
	double degreeActivationWangMendel;
	/** Antecedentes representados pelos próprios conjuntos fuzzy afim de auxliar no wang-mendel */
	ArrayList<LinguisticTerm> antecedentesConjuntosFuzzy;
	...
	public Rule(String name, RuleBlock ruleBlock) {
		...
		antecedentesConjuntosFuzzy = new ArrayList<LinguisticTerm>();
	...
	public double getDegreeActivationWangMendel() {
		return degreeActivationWangMendel;
	}

	public void setDegreeActivationWangMendel(double degreeActivationWangMendel) {
		this.degreeActivationWangMendel = degreeActivationWangMendel;
	}

	public ArrayList<LinguisticTerm> getAntecedentesConjuntosFuzzy() {
		return antecedentesConjuntosFuzzy;
	}

	public void setAntecedentesConjuntosFuzzy(ArrayList<LinguisticTerm> antecedentesConjuntosFuzzy) {
		this.antecedentesConjuntosFuzzy = antecedentesConjuntosFuzzy;
	}
